...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-36d59c97.mjs').then((m) => m.default || m)
  },
  {
    name: "post-slug",
    path: "/post/:slug()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-e8a87ca6.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-344069bd.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-daf6dfd8.mjs').then((r) => r.default || r));
...
export { Site as S, useSanityQuery as a, useRoute as b, createError as c, entry$1 as default, navigateTo as n, useRouter as u };
