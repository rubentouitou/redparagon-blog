import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, nextTick, shallowRef, shallowReactive, isReadonly, isShallow, isReactive, toRaw, ref, onServerPrefetch, unref, defineComponent, provide, h, Suspense, Transition, useSSRContext, mergeProps, defineAsyncComponent, onErrorCaptured, createVNode, resolveDynamicComponent, createApp } from "vue";
...
import { ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-36d59c97.js").then((m) => m.default || m)
  },
  {
    name: "post-slug",
    path: "/post/:slug()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-e8a87ca6.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-344069bd.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-daf6dfd8.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-ceb08a05.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
